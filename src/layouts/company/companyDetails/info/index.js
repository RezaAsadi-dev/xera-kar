 ...
 const [selectedMedia, setSelectedMedia] = useState();
  ...
  return (
    <div className=" grid md:grid-cols-3  grid-cols-1 mt-8 gap-10 ">
      ...
      {
        mediaItems && (
          <Card sx={{ display:"flex", flexDirection:"column" ,justifyContent:"space-around", alignItems:"center" , position: "relative", overflowY: "auto", height: "100%" }}>
            {/* Main Media Display */}
            <div className="main-media-display w-full  " style={{ textAlign: "center", marginBottom: "20px" }}>
           <div className="flex justify-center items-center">
            ...
            {/* Horizontal Slider */}
            <div className="slide-container w-full" style={{ display: "flex", overflowX: "auto", paddingBottom: "10px", paddingRight: "5px" }}>
